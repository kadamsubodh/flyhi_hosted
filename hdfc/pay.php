	...
	<form  method="post" action="post.php" name="frmTransaction" id="frmTransaction" >  	 
     <table width="600" cellpadding="2" cellspacing="2" border="0">
	   ...
	   <tr>
            ...
            <td  align="left" width="50%"> <input name="reference_no" type="text" value="<?=time();?>" /></td>
        </tr>
        <tr>
            <td class="fieldName" width="50%"><span class="error">*</span> Sale Amount</td>
            <td  align="left" width="50%"> <input name="amount" type="text" value="<?=rand(100,999);?>" /> <select name="currency" >
        ...
        <tr>
            ...
            <td  align="left" width="50%"> <input name="description" type="text" value="Test Product" /></td>
        </tr>
		      <tr>
        ...
        <tr>
            ...
            <td align="left">
                <input name="city" type="text" value="Mumbai" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
               <input name="state" type="text" value="MH" />
        ...
        <tr>
            ...
            <td align="left">
                <input name="postal_code" type="text" value="400069" />
            </td>
        ...
        <tr>
            ...
            <td align="left">
                <input name="ship_city" type="text" value="Mumbai" />
            </td>
        ...
        <tr>
            <td class="fieldName">State/Province</td>
            <td align="left">
               <input name="ship_state" type="text" value="MH" />
            </td>
        </tr>
